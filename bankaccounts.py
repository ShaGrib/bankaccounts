...
monty.make_deposit(1000).make_deposit(2500).ask_interest_approval().display_user_balance()
armen.make_deposit(100).make_withdrawal(87).make_withdrawal(64).make_withdrawal(10).ask_interest_approval().display_user_balance()